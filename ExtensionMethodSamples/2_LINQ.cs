...
namespace ExtensionMethodSamples
{
    public class LinqExamples
    {
        ...
        {
            int totalStudents = _studentData.Count(s => s.FirstName == "Steve"); // => lambda
            int count = 0;
        ...
        [Fact]
        public void Select() // collection of values
        {
        ...
        [Fact]
        public void SelectManyAndCount() // conglomerate of collection of values
        {
        ...
        [Fact]
        public void Where() // filter down the information for exactly what you want
        {
            ...
            var resule = _studentData
                .SelectMany<s => sbyte.CompletedCourses)
                .Where(char => !char.GradeReceived.Passing())
